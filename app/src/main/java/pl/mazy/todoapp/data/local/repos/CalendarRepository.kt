...
//    fun selEvents():List<Events>{
//        return database.calendarQueries.selBetweenDate(today,today).executeAsList().map {
//                e -> Events(e.id,e.Name,e.Description,e.Category,e.TimeStart,e.TimeEnd,e.DateStart,e.DateEnd,e.Type,e.Checked,e.Color,e.MainTaskID, listOf())
//        }
//    }
//
...
//    }
//
//    fun addEvent(ev: Events, subList:List<String>, owner:Long){
...
//    }
//
//    fun updateEvent(event: Events, subList: List<String>){
...
//        toggleCheck(event)
//    }
//    private fun toggleCheck(ev: Events){
...
//                toggleCheck(Events(c.id,c.Name,c.Description,c.Category,c.TimeStart,c.TimeEnd,c.DateStart,c.DateEnd,c.Type,c.Checked,c.Color,c.MainTaskID, listOf()))
//            }
//        }
//    }
